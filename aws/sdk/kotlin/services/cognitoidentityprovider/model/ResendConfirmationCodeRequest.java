...
public final class ResendConfirmationCodeRequest {
    ...
    public ResendConfirmationCodeRequest(Builder builder) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (Intrinsics.areEqual(this.analyticsMetadata, resendConfirmationCodeRequest.analyticsMetadata) && Intrinsics.areEqual(this.clientId, resendConfirmationCodeRequest.clientId) && Intrinsics.areEqual(this.clientMetadata, resendConfirmationCodeRequest.clientMetadata) && Intrinsics.areEqual(this.secretHash, resendConfirmationCodeRequest.secretHash) && Intrinsics.areEqual(this.userContextData, resendConfirmationCodeRequest.userContextData) && Intrinsics.areEqual(this.username, resendConfirmationCodeRequest.username)) {
            return true;
        }
        return false;
    }
