...
public final class ForgotPasswordOperationDeserializer implements HttpDeserialize<ForgotPasswordResponse> {
    ...
    */
    public final java.lang.Object deserialize(aws.smithy.kotlin.runtime.operation.ExecutionContext r6, aws.smithy.kotlin.runtime.http.response.HttpResponse r7, kotlin.coroutines.Continuation<? super aws.sdk.kotlin.services.cognitoidentityprovider.model.ForgotPasswordResponse> r8) {
        /*
            r5 = this;
            boolean r0 = r8 instanceof aws.sdk.kotlin.services.cognitoidentityprovider.transform.ForgotPasswordOperationDeserializer$deserialize$1
            if (r0 == 0) goto L13
            r0 = r8
            aws.sdk.kotlin.services.cognitoidentityprovider.transform.ForgotPasswordOperationDeserializer$deserialize$1 r0 = (aws.sdk.kotlin.services.cognitoidentityprovider.transform.ForgotPasswordOperationDeserializer$deserialize$1) r0
            int r1 = r0.label
            ...
            goto L18
        L13:
            aws.sdk.kotlin.services.cognitoidentityprovider.transform.ForgotPasswordOperationDeserializer$deserialize$1 r0 = new aws.sdk.kotlin.services.cognitoidentityprovider.transform.ForgotPasswordOperationDeserializer$deserialize$1
            r0.<init>(r5, r8)
        L18:
            ...
            if (r2 == r4) goto L34
            if (r2 != r3) goto L2c
            aws.sdk.kotlin.services.cognitoidentityprovider.model.ForgotPasswordResponse$Builder r6 = r0.L$0
        ...
        L38:
            ...
            if (r8 != 0) goto L52
            r0.label = r4
            kotlin.coroutines.intrinsics.CoroutineSingletons r6 = aws.sdk.kotlin.services.cognitoidentityprovider.transform.ForgotPasswordOperationDeserializerKt.access$throwForgotPasswordError(r6, r7, r0)
            if (r6 != r1) goto L4c
            return r1
        L4c:
            ...
            throw r6
        L52:
            aws.sdk.kotlin.services.cognitoidentityprovider.model.ForgotPasswordResponse$Builder r6 = new aws.sdk.kotlin.services.cognitoidentityprovider.model.ForgotPasswordResponse$Builder
            r6.<init>()
            r0.L$0 = r6
            r0.label = r3
