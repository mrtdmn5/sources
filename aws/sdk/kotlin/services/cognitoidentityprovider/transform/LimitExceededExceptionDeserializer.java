...
public final class LimitExceededExceptionDeserializer implements HttpDeserialize<LimitExceededException> {
    ...
    */
    public final java.lang.Object deserialize(aws.smithy.kotlin.runtime.operation.ExecutionContext r6, aws.smithy.kotlin.runtime.http.response.HttpResponse r7, kotlin.coroutines.Continuation<? super aws.sdk.kotlin.services.cognitoidentityprovider.model.LimitExceededException> r8) {
        /*
            r5 = this;
            boolean r6 = r8 instanceof aws.sdk.kotlin.services.cognitoidentityprovider.transform.LimitExceededExceptionDeserializer$deserialize$1
            if (r6 == 0) goto L13
            r6 = r8
            aws.sdk.kotlin.services.cognitoidentityprovider.transform.LimitExceededExceptionDeserializer$deserialize$1 r6 = (aws.sdk.kotlin.services.cognitoidentityprovider.transform.LimitExceededExceptionDeserializer$deserialize$1) r6
            int r0 = r6.label
            ...
            goto L18
        L13:
            aws.sdk.kotlin.services.cognitoidentityprovider.transform.LimitExceededExceptionDeserializer$deserialize$1 r6 = new aws.sdk.kotlin.services.cognitoidentityprovider.transform.LimitExceededExceptionDeserializer$deserialize$1
            r6.<init>(r5, r8)
        L18:
            ...
            if (r1 == 0) goto L31
            if (r1 != r2) goto L29
            aws.sdk.kotlin.services.cognitoidentityprovider.model.LimitExceededException$Builder r6 = r6.L$0
        ...
        L31:
            kotlin.ResultKt.throwOnFailure(r8)
            aws.sdk.kotlin.services.cognitoidentityprovider.model.LimitExceededException$Builder r8 = new aws.sdk.kotlin.services.cognitoidentityprovider.model.LimitExceededException$Builder
            r8.<init>()
