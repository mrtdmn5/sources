...
public final class ListDevicesOperationSerializer implements HttpSerialize<ListDevicesRequest> {
    ...
    public final HttpRequestBuilder serialize(Object obj) {
        ...
        HttpRequestBuilderKt.url(httpRequestBuilder, new Function1<UrlBuilder, Unit>() { // from class: aws.sdk.kotlin.services.cognitoidentityprovider.transform.ListDevicesOperationSerializer$serialize$2
        ...
        SdkFieldDescriptor sdkFieldDescriptor2 = new SdkFieldDescriptor(SerialKind.Integer.INSTANCE, new JsonSerialName("Limit"));
        SdkFieldDescriptor sdkFieldDescriptor3 = new SdkFieldDescriptor(string, new JsonSerialName("PaginationToken"));
        ...
        String str = listDevicesRequest.accessToken;
        if (str != null) {
