...
/* compiled from: ForgotPasswordOperationSerializer.kt */
/* loaded from: classes.dex */
public final class ForgotPasswordOperationSerializer implements HttpSerialize<ForgotPasswordRequest> {
    @Override // aws.smithy.kotlin.runtime.http.operation.HttpSerialize
    public final HttpRequestBuilder serialize(Object obj) {
        final ForgotPasswordRequest forgotPasswordRequest = (ForgotPasswordRequest) obj;
        HttpRequestBuilder httpRequestBuilder = new HttpRequestBuilder();
        httpRequestBuilder.setMethod(HttpMethod.POST);
        HttpRequestBuilderKt.url(httpRequestBuilder, new Function1<UrlBuilder, Unit>() { // from class: aws.sdk.kotlin.services.cognitoidentityprovider.transform.ForgotPasswordOperationSerializer$serialize$2
        ...
        AnalyticsMetadataType analyticsMetadataType = forgotPasswordRequest.analyticsMetadata;
        if (analyticsMetadataType != null) {
            TimeZoneKt.field(jsonSerializer, sdkFieldDescriptor, analyticsMetadataType, ForgotPasswordOperationSerializerKt$serializeForgotPasswordOperationBody$1$1$1.INSTANCE);
        }
        String str = forgotPasswordRequest.clientId;
        if (str != null) {
            jsonSerializer.field(sdkFieldDescriptor2, str);
        }
        if (forgotPasswordRequest.clientMetadata != null) {
            jsonSerializer.mapField(sdkFieldDescriptor3, new Function1<MapSerializer, Unit>() { // from class: aws.sdk.kotlin.services.cognitoidentityprovider.transform.ForgotPasswordOperationSerializerKt$serializeForgotPasswordOperationBody$1$3
                {
                    super(1);
                }
                ...
                public final Unit invoke(MapSerializer mapSerializer) {
                    ...
                    for (Map.Entry<String, String> entry : ForgotPasswordRequest.this.clientMetadata.entrySet()) {
        ...
        String str2 = forgotPasswordRequest.secretHash;
        if (str2 != null) {
            jsonSerializer.field(sdkFieldDescriptor4, str2);
        }
        UserContextDataType userContextDataType = forgotPasswordRequest.userContextData;
        if (userContextDataType != null) {
            TimeZoneKt.field(jsonSerializer, sdkFieldDescriptor5, userContextDataType, ForgotPasswordOperationSerializerKt$serializeForgotPasswordOperationBody$1$5$1.INSTANCE);
        }
        String str3 = forgotPasswordRequest.username;
        if (str3 != null) {
