...
public final class ResourceNotFoundExceptionDeserializer implements HttpDeserialize<ResourceNotFoundException> {
    ...
    */
    public final java.lang.Object deserialize(aws.smithy.kotlin.runtime.operation.ExecutionContext r6, aws.smithy.kotlin.runtime.http.response.HttpResponse r7, kotlin.coroutines.Continuation<? super aws.sdk.kotlin.services.cognitoidentity.model.ResourceNotFoundException> r8) {
        /*
            r5 = this;
            boolean r6 = r8 instanceof aws.sdk.kotlin.services.cognitoidentity.transform.ResourceNotFoundExceptionDeserializer$deserialize$1
            if (r6 == 0) goto L13
            r6 = r8
            aws.sdk.kotlin.services.cognitoidentity.transform.ResourceNotFoundExceptionDeserializer$deserialize$1 r6 = (aws.sdk.kotlin.services.cognitoidentity.transform.ResourceNotFoundExceptionDeserializer$deserialize$1) r6
            int r0 = r6.label
            ...
            goto L18
        L13:
            aws.sdk.kotlin.services.cognitoidentity.transform.ResourceNotFoundExceptionDeserializer$deserialize$1 r6 = new aws.sdk.kotlin.services.cognitoidentity.transform.ResourceNotFoundExceptionDeserializer$deserialize$1
            r6.<init>(r5, r8)
        L18:
            ...
            if (r1 == 0) goto L31
            if (r1 != r2) goto L29
            aws.sdk.kotlin.services.cognitoidentity.model.ResourceNotFoundException$Builder r6 = r6.L$0
        ...
        L31:
            kotlin.ResultKt.throwOnFailure(r8)
            aws.sdk.kotlin.services.cognitoidentity.model.ResourceNotFoundException$Builder r8 = new aws.sdk.kotlin.services.cognitoidentity.model.ResourceNotFoundException$Builder
            r8.<init>()
        ...
        L89:
            r6.getClass()
            aws.sdk.kotlin.services.cognitoidentity.model.ResourceNotFoundException r7 = new aws.sdk.kotlin.services.cognitoidentity.model.ResourceNotFoundException
            r7.<init>(r6)
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: aws.sdk.kotlin.services.cognitoidentity.transform.ResourceNotFoundExceptionDeserializer.deserialize(aws.smithy.kotlin.runtime.operation.ExecutionContext, aws.smithy.kotlin.runtime.http.response.HttpResponse, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
