...
public final class ResolveEndpoint<I> implements Interceptor<Object, Object, HttpRequest, HttpResponse> {
    ...
    public ResolveEndpoint(UtilsKt endpointProvider, Function2 function2) {
    ...
    */
    public final java.lang.Object modifyBeforeRetryLoop(aws.smithy.kotlin.runtime.http.interceptors.HttpProtocolRequestInterceptorContext r5, kotlin.coroutines.Continuation r6) {
        /*
            r4 = this;
            boolean r0 = r6 instanceof aws.sdk.kotlin.services.cognitoidentity.endpoints.internal.ResolveEndpoint$modifyBeforeRetryLoop$1
            if (r0 == 0) goto L13
            r0 = r6
            aws.sdk.kotlin.services.cognitoidentity.endpoints.internal.ResolveEndpoint$modifyBeforeRetryLoop$1 r0 = (aws.sdk.kotlin.services.cognitoidentity.endpoints.internal.ResolveEndpoint$modifyBeforeRetryLoop$1) r0
            int r1 = r0.label
            ...
            goto L18
        L13:
            aws.sdk.kotlin.services.cognitoidentity.endpoints.internal.ResolveEndpoint$modifyBeforeRetryLoop$1 r0 = new aws.sdk.kotlin.services.cognitoidentity.endpoints.internal.ResolveEndpoint$modifyBeforeRetryLoop$1
            r0.<init>(r4, r6)
        L18:
        ...
        L31:
            kotlin.ResultKt.throwOnFailure(r6)
            aws.sdk.kotlin.services.cognitoidentity.endpoints.EndpointParameters r6 = r4.params
            if (r6 == 0) goto L91
            r0.L$0 = r5
            r0.label = r3
            aws.smithy.kotlin.runtime.client.endpoints.EndpointProvider<aws.sdk.kotlin.services.cognitoidentity.endpoints.EndpointParameters> r2 = r4.endpointProvider
        ...
        L45:
            ...
            aws.sdk.kotlin.services.cognitoidentity.endpoints.internal.ResolveEndpoint$modifyBeforeRetryLoop$2 r1 = new aws.sdk.kotlin.services.cognitoidentity.endpoints.internal.ResolveEndpoint$modifyBeforeRetryLoop$2
            r1.<init>()
            ...
            java.lang.Class<aws.sdk.kotlin.services.cognitoidentity.endpoints.internal.ResolveEndpoint> r3 = aws.sdk.kotlin.services.cognitoidentity.endpoints.internal.ResolveEndpoint.class
        ...
        L91:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: aws.sdk.kotlin.services.cognitoidentity.endpoints.internal.ResolveEndpoint.modifyBeforeRetryLoop(aws.smithy.kotlin.runtime.http.interceptors.HttpProtocolRequestInterceptorContext, kotlin.coroutines.Continuation):java.lang.Object");
    }
