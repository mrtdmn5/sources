...
public final class MonthBasedDateTimeUnitSerializer implements KSerializer<DateTimeUnit.MonthBased> {
    ...
    public static final SerialDescriptorImpl descriptor = SerialDescriptorsKt.buildClassSerialDescriptor("MonthBased", new SerialDescriptor[0], new Function1<ClassSerialDescriptorBuilder, Unit>() { // from class: kotlinx.datetime.serializers.MonthBasedDateTimeUnitSerializer$descriptor$1
        ...
        public final Unit invoke(ClassSerialDescriptorBuilder classSerialDescriptorBuilder) {
            ...
            buildClassSerialDescriptor.element("months", ExceptionsKt.serializer(SerializersModuleKt.EmptySerializersModule, Reflection.typeOf(Integer.TYPE)).getDescriptor(), EmptyList.INSTANCE, false);
    ...
    public final Object deserialize(Decoder decoder) {
        ...
        while (true) {
            ...
            if (decodeElementIndex != -1) {
                ...
                if (z) {
                    return new DateTimeUnit.MonthBased(r3);
                }
