...
public final class Huffman {
    ...
    static {
        for (int r1 = 0; r1 < 256; r1++) {
            addCode(r1, CODES[r1], CODE_BIT_COUNTS[r1]);
        }
    }

    public static void addCode(int r3, int r4, int r5) {
        Node node = new Node(r3, r5);
        Node node2 = root;
        while (true) {
            ...
            if (r5 > 8) {
                ...
                int r42 = (r4 << r12) & 255;
                Intrinsics.checkNotNull(nodeArr);
                Arrays.fill(nodeArr, r42, (1 << r12) + r42, node);
                return;
            }
        }
    }
    ...
    public static final class Node {
        ...
        public Node(int r2, int r3) {
            ...
            this.symbol = r2;
            int r22 = r3 & 7;
            this.terminalBitCount = r22 == 0 ? 8 : r22;
        }
    }
}
