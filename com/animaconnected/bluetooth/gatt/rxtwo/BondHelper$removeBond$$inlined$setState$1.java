...
@DebugMetadata(c = "com.animaconnected.bluetooth.gatt.rxtwo.BondHelper$removeBond$$inlined$setState$1", f = "BondHelper.kt", l = {96}, m = "invokeSuspend")
/* loaded from: classes.dex */
public final class BondHelper$removeBond$$inlined$setState$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super BondHelper.Result>, Object> {
    ...
    /* compiled from: BondHelper.kt */
    /* renamed from: com.animaconnected.bluetooth.gatt.rxtwo.BondHelper$removeBond$$inlined$setState$1$1, reason: invalid class name */
    /* loaded from: classes.dex */
    ...
    public BondHelper$removeBond$$inlined$setState$1(BondHelper bondHelper, Ref$ObjectRef ref$ObjectRef, int r3, Continuation continuation, BondHelper bondHelper2) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        BondHelper$removeBond$$inlined$setState$1 bondHelper$removeBond$$inlined$setState$1 = new BondHelper$removeBond$$inlined$setState$1(this.this$0$inline_fun, this.$receiver, this.$bondState, continuation, this.this$0);
        bondHelper$removeBond$$inlined$setState$1.L$0 = obj;
        return bondHelper$removeBond$$inlined$setState$1;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r2v6, types: [T, com.animaconnected.bluetooth.gatt.rxtwo.BondHelper$removeBond$$inlined$setState$1$1] */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Object invokeSuspend(Object obj) {
        ...
        if (r1 != 0) {
            ...
            boolean z = false;
            Object invoke = BluetoothDevice.class.getMethod("removeBond", new Class[0]).invoke(this.this$0.getBluetoothDevice(), new Object[0]);
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r0v2, types: [T, com.animaconnected.bluetooth.gatt.rxtwo.BondHelper$removeBond$$inlined$setState$1$1] */
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super BondHelper.Result> continuation) {
        return ((BondHelper$removeBond$$inlined$setState$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
