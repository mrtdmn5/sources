package com.animaconnected.watch.behaviour.dice;
...
public final class Dice implements Complication {
    public static final Companion Companion = new Companion(null);
    public static final String TYPE;
    private Watch watch;
    private final String type = TYPE;
    private final String analyticsName = "dice";
    private final int deviceComplicationMode = 9;
    ...
    static {
        String simpleName = Reflection.getOrCreateKotlinClass(Dice.class).getSimpleName();
        if (simpleName == null) {
            simpleName = "Dice";
        }
        TYPE = simpleName;
    ...
    public boolean isSelectable(Watch watch) {
        Intrinsics.checkNotNullParameter(watch, "watch");
        return watch.getCapabilities().getHasDice();
    }
}
