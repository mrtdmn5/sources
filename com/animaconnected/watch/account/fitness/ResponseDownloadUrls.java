...
public final class ResponseDownloadUrls {
    ...
    public static final class Data {
        ...
        public /* synthetic */ Data(int r2, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
            if (3 != (r2 & 3)) {
                zzac.throwMissingFieldException(r2, 3, ResponseDownloadUrls$Data$$serializer.INSTANCE.getDescriptor());
                throw null;
            }
            this.date = str;
            this.url = str2;
    ...
    public /* synthetic */ ResponseDownloadUrls(int r2, List list, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 == (r2 & 1)) {
            this.data = list;
        } else {
            zzac.throwMissingFieldException(r2, 1, ResponseDownloadUrls$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ ResponseDownloadUrls copy$default(ResponseDownloadUrls responseDownloadUrls, List list, int r2, Object obj) {
        if ((r2 & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof ResponseDownloadUrls) && Intrinsics.areEqual(this.data, ((ResponseDownloadUrls) obj).data)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return LocaleList$$ExternalSyntheticOutline0.m(new StringBuilder("ResponseDownloadUrls(data="), this.data, ')');
    }
