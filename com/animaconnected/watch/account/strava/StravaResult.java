...
public abstract class StravaResult<T> {

    /* compiled from: StravaHttpClient.kt */
    /* loaded from: classes3.dex */
    public static final class Failure<T> extends StravaResult<T> {
    ...
    /* compiled from: StravaHttpClient.kt */
    /* loaded from: classes3.dex */
    public static final class Success<T> extends StravaResult<T> {
    ...
    public /* synthetic */ StravaResult(DefaultConstructorMarker defaultConstructorMarker) {
        this();
    }

    private StravaResult() {
    }
}
