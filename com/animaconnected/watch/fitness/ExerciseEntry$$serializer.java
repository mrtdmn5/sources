...
public final class ExerciseEntry$$serializer implements GeneratedSerializer<ExerciseEntry> {
    public static final ExerciseEntry$$serializer INSTANCE;
    private static final /* synthetic */ PluginGeneratedSerialDescriptor descriptor;

    static {
        ExerciseEntry$$serializer exerciseEntry$$serializer = new ExerciseEntry$$serializer();
        INSTANCE = exerciseEntry$$serializer;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.animaconnected.watch.fitness.ExerciseEntry", exerciseEntry$$serializer, 3);
        ...
        pluginGeneratedSerialDescriptor.addElement("activeMinutes", false);
        descriptor = pluginGeneratedSerialDescriptor;
    }

    private ExerciseEntry$$serializer() {
    }
    ...
    public ExerciseEntry deserialize(Decoder decoder) {
        ...
        return new ExerciseEntry(r7, str, j, r11, null, null);
    }
    ...
    public void serialize(Encoder encoder, ExerciseEntry value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder beginStructure = encoder.beginStructure(descriptor2);
        ExerciseEntry.write$Self$watch_release(value, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
