...
public final class StressEntry$$serializer implements GeneratedSerializer<StressEntry> {
    public static final StressEntry$$serializer INSTANCE;
    private static final /* synthetic */ PluginGeneratedSerialDescriptor descriptor;

    static {
        StressEntry$$serializer stressEntry$$serializer = new StressEntry$$serializer();
        INSTANCE = stressEntry$$serializer;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.animaconnected.watch.fitness.StressEntry", stressEntry$$serializer, 3);
    ...
    private StressEntry$$serializer() {
    }
    ...
    public StressEntry deserialize(Decoder decoder) {
        ...
        return new StressEntry(r7, str, j, r11, null, null);
    }
    ...
    public void serialize(Encoder encoder, StressEntry value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder beginStructure = encoder.beginStructure(descriptor2);
        StressEntry.write$Self$watch_release(value, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
