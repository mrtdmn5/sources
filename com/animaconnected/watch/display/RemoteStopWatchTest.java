...
public final class RemoteStopWatchTest extends RemoteAppImpl {
    private final String type = "TestStopwatch";
    ...
    public List<Display> getDisplays() {
        return CollectionsKt__CollectionsKt.listOf(DisplayDefinitionKt.display(new Function1<Display, Unit>() { // from class: com.animaconnected.watch.display.RemoteStopWatchTest$getDisplays$1
            {
                super(1);
            }
            ...
            public final void invoke2(Display display) {
                ...
                final RemoteStopWatchTest remoteStopWatchTest = RemoteStopWatchTest.this;
                DisplayDefinitionKt.subDisplaySafeArea(display, new Function1<Rectangle, Unit>() { // from class: com.animaconnected.watch.display.RemoteStopWatchTest$getDisplays$1.1
                    {
                        super(1);
                    }
                    ...
                    public final void invoke2(Rectangle subDisplaySafeArea) {
                        ...
                        final RemoteStopWatchTest remoteStopWatchTest2 = RemoteStopWatchTest.this;
                        DisplayDefinitionKt.listView$default(subDisplaySafeArea, 0, 0, width, height, new Function1<ListView, Unit>() { // from class: com.animaconnected.watch.display.RemoteStopWatchTest.getDisplays.1.1.1
                            {
                                super(1);
                            }
                            ...
                            public final void invoke2(ListView listView) {
                                ...
                                DisplayDefinitionKt.text$default(listView, StringsExtensionsKt.m1571static("StopWatch"), RemoteStopWatchTest.this.getPaint().getDefault(), false, null, null, 28, null);
                                DisplayDefinitionKt.space$default(listView, 0, 2, null, 5, null);
                                DisplayDefinitionKt.line(listView, Integer.MIN_VALUE, Integer.MIN_VALUE, listView.getWidth(), 0, new Function1<Line, Unit>() { // from class: com.animaconnected.watch.display.RemoteStopWatchTest.getDisplays.1.1.1.1
                                    @Override // kotlin.jvm.functions.Function1
                                    ...
                                    public final void invoke2(Line line) {
                                        ...
                                        line.m1112setColorukcjflE(Kolor.m1537constructorimpl(Kolors.orangeRed));
                                    }
                                });
                                DisplayDefinitionKt.space$default(listView, 0, 6, null, 5, null);
                                int width2 = listView.getWidth();
                                final RemoteStopWatchTest remoteStopWatchTest3 = RemoteStopWatchTest.this;
                                DisplayDefinitionKt.listView$default(listView, 0, 0, width2, 20, new Function1<ListView, Unit>() { // from class: com.animaconnected.watch.display.RemoteStopWatchTest.getDisplays.1.1.1.2
                                    {
                                        super(1);
                                    }
                                    ...
                                    public final void invoke2(ListView listView2) {
                                        ...
                                        DisplayDefinitionKt.text$default(listView2, StringsExtensionsKt.m1571static("Time:"), RemoteStopWatchTest.this.getPaint().getDefault(), false, null, null, 28, null);
                                        DisplayDefinitionKt.variable$default(listView2, VarType.ActivityStepsToday, null, 2, null);
                                    }
                                }, 3, null);
                                DisplayDefinitionKt.line(listView, Integer.MIN_VALUE, Integer.MIN_VALUE, listView.getWidth(), 0, new Function1<Line, Unit>() { // from class: com.animaconnected.watch.display.RemoteStopWatchTest.getDisplays.1.1.1.3
                                    @Override // kotlin.jvm.functions.Function1
                                    public /* bridge */ /* synthetic */ Unit invoke(Line line) {
                                        invoke2(line);
                                        return Unit.INSTANCE;
                                ...
                                DisplayDefinitionKt.space$default(listView, 0, 6, null, 5, null);
                                DisplayDefinitionKt.text$default(listView, StringsExtensionsKt.m1571static("Start"), RemoteStopWatchTest.this.getPaint().getDefault(), false, null, new Function1<Text, Unit>() { // from class: com.animaconnected.watch.display.RemoteStopWatchTest.getDisplays.1.1.1.4
                                    @Override // kotlin.jvm.functions.Function1
                                ...
                                DisplayDefinitionKt.space$default(listView, 0, 2, null, 5, null);
                                DisplayDefinitionKt.text$default(listView, StringsExtensionsKt.m1571static("Lap"), RemoteStopWatchTest.this.getPaint().getDefault(), false, null, new Function1<Text, Unit>() { // from class: com.animaconnected.watch.display.RemoteStopWatchTest.getDisplays.1.1.1.5
                                    @Override // kotlin.jvm.functions.Function1
                                    public /* bridge */ /* synthetic */ Unit invoke(Text text) {
                                        invoke2(text);
                                        return Unit.INSTANCE;
                ...
                DisplayDefinitionKt.bottomPusher(display, new Function1<BottomPusher, Unit>() { // from class: com.animaconnected.watch.display.RemoteStopWatchTest$getDisplays$1.2
                    @Override // kotlin.jvm.functions.Function1
