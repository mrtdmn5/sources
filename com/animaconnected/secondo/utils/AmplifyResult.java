...
public abstract class AmplifyResult<T> {
    public static final int $stable = 0;

    /* compiled from: AmplifyApi.kt */
    /* loaded from: classes3.dex */
    public static final class Failure<T> extends AmplifyResult<T> {
    ...
    /* compiled from: AmplifyApi.kt */
    /* loaded from: classes3.dex */
    public static final class Success<T> extends AmplifyResult<T> {
        public static final int $stable = 0;
    ...
    /* compiled from: AmplifyApi.kt */
    /* loaded from: classes3.dex */
    public static final class SuccessNothingDone extends AmplifyResult {
        public static final int $stable = 0;
        public static final SuccessNothingDone INSTANCE = new SuccessNothingDone();

        private SuccessNothingDone() {
            super(null);
        }
    }

    public /* synthetic */ AmplifyResult(DefaultConstructorMarker defaultConstructorMarker) {
        this();
    }

    private AmplifyResult() {
    }
}
