...
@DebugMetadata(c = "com.animaconnected.secondo.screens.debugsettings.graphs.DebugCaloriesChartFragment$on7DaysClick$1", f = "DebugCaloriesChartFragment.kt", l = {76}, m = "invokeSuspend")
/* loaded from: classes3.dex */
public final class DebugCaloriesChartFragment$on7DaysClick$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    private /* synthetic */ Object L$0;
    int label;
    final /* synthetic */ DebugCaloriesChartFragment this$0;

    /* compiled from: DebugCaloriesChartFragment.kt */
    @DebugMetadata(c = "com.animaconnected.secondo.screens.debugsettings.graphs.DebugCaloriesChartFragment$on7DaysClick$1$1", f = "DebugCaloriesChartFragment.kt", l = {}, m = "invokeSuspend")
    /* renamed from: com.animaconnected.secondo.screens.debugsettings.graphs.DebugCaloriesChartFragment$on7DaysClick$1$1, reason: invalid class name */
    /* loaded from: classes3.dex */
    ...
    /* compiled from: DebugCaloriesChartFragment.kt */
    @DebugMetadata(c = "com.animaconnected.secondo.screens.debugsettings.graphs.DebugCaloriesChartFragment$on7DaysClick$1$2", f = "DebugCaloriesChartFragment.kt", l = {}, m = "invokeSuspend")
    /* renamed from: com.animaconnected.secondo.screens.debugsettings.graphs.DebugCaloriesChartFragment$on7DaysClick$1$2, reason: invalid class name */
    /* loaded from: classes3.dex */
    public static final class AnonymousClass2 extends SuspendLambda implements Function3<FlowCollector<? super ChartData<? extends BarEntry>>, Throwable, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ResultKt.throwOnFailure(obj);
                LogKt.debug$default(this.L$0, "Exception from last week steps, maybe watch was just closed?", this.this$0.getName(), (Throwable) this.L$1, false, 8, (Object) null);
                return Unit.INSTANCE;
            }
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DebugCaloriesChartFragment$on7DaysClick$1(DebugCaloriesChartFragment debugCaloriesChartFragment, Continuation<? super DebugCaloriesChartFragment$on7DaysClick$1> continuation) {
        super(2, continuation);
        this.this$0 = debugCaloriesChartFragment;
    }
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        DebugCaloriesChartFragment$on7DaysClick$1 debugCaloriesChartFragment$on7DaysClick$1 = new DebugCaloriesChartFragment$on7DaysClick$1(this.this$0, continuation);
        debugCaloriesChartFragment$on7DaysClick$1.L$0 = obj;
        return debugCaloriesChartFragment$on7DaysClick$1;
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((DebugCaloriesChartFragment$on7DaysClick$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
