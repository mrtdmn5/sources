...
@DebugMetadata(c = "com.animaconnected.secondo.screens.workout.WorkoutMetricHistoryBaseFragment$onCreateView$1$2", f = "WorkoutMetricHistoryBaseFragment.kt", l = {}, m = "invokeSuspend")
/* loaded from: classes3.dex */
public final class WorkoutMetricHistoryBaseFragment$onCreateView$1$2 extends SuspendLambda implements Function2<View, Continuation<? super Unit>, Object> {
    int label;
    ...
    public WorkoutMetricHistoryBaseFragment$onCreateView$1$2(WorkoutMetricHistoryBaseFragment workoutMetricHistoryBaseFragment, Continuation<? super WorkoutMetricHistoryBaseFragment$onCreateView$1$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new WorkoutMetricHistoryBaseFragment$onCreateView$1$2(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(View view, Continuation<? super Unit> continuation) {
        return ((WorkoutMetricHistoryBaseFragment$onCreateView$1$2) create(view, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ...
            if (r2 == 1) {
                ...
                workoutDatePickerViewModel.changeWeek(Action.NextDate);
            } else if (r2 == 2) {
                workoutDatePickerViewModel2 = this.this$0.viewModel;
                workoutDatePickerViewModel2.changeMonth(Action.NextDate);
            } else if (r2 == 3) {
                workoutDatePickerViewModel3 = this.this$0.viewModel;
                workoutDatePickerViewModel3.changeYear(Action.NextDate);
            }
