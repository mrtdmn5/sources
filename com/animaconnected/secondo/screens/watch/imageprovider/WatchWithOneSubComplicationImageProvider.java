...
import com.animaconnected.secondo.behaviour.watchbattery.WatchBattery;
...
public class WatchWithOneSubComplicationImageProvider extends WatchImageProvider {
    ...
    public int getComplicationsDragAndDropTargetLayout() {
        return R.layout.complications_draganddrop_target_layout_one_sub_complication;
    }
    ...
    public int getWatchDynamicImageHourHandResource(String str, Slot slot) {
        if (slot != Slot.SubComplication1 && slot != Slot.SubComplication2) {
            if (slot != Slot.MainComplication && slot != Slot.MainComplicationDouble) {
                if (slot == Slot.Unknown) {
                    if (str.equals(Date.TYPE) || str.equals(Steps.type) || str.equals(WatchBattery.TYPE)) {
        ...
        if (!str.equals(Steps.type) && !str.equals(WatchBattery.TYPE)) {
            return R.drawable.secondo_main_hour_hand;
        }
        return R.drawable.big_hand_android;
    }
