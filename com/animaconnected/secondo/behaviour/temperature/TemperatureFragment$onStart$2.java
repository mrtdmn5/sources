...
@DebugMetadata(c = "com.animaconnected.secondo.behaviour.temperature.TemperatureFragment$onStart$2", f = "TemperatureFragment.kt", l = {133}, m = "invokeSuspend")
/* loaded from: classes3.dex */
public final class TemperatureFragment$onStart$2 extends SuspendLambda implements Function2<View, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ TemperatureFragment this$0;

    /* compiled from: TemperatureFragment.kt */
    @DebugMetadata(c = "com.animaconnected.secondo.behaviour.temperature.TemperatureFragment$onStart$2$1", f = "TemperatureFragment.kt", l = {R.styleable.AppTheme_stepsHistoryBaseLineColorDetail}, m = "invokeSuspend")
    /* renamed from: com.animaconnected.secondo.behaviour.temperature.TemperatureFragment$onStart$2$1, reason: invalid class name */
    /* loaded from: classes3.dex */
    ...
    public TemperatureFragment$onStart$2(TemperatureFragment temperatureFragment, Continuation<? super TemperatureFragment$onStart$2> continuation) {
        super(2, continuation);
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new TemperatureFragment$onStart$2(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(View view, Continuation<? super Unit> continuation) {
        return ((TemperatureFragment$onStart$2) create(view, continuation)).invokeSuspend(Unit.INSTANCE);
    }
