...
public final class ComplicationsDraganddropTargetLayoutOneSubComplicationBinding implements ViewBinding {
    ...
    private ComplicationsDraganddropTargetLayoutOneSubComplicationBinding(BehaviourDragAndDropTargetLayout behaviourDragAndDropTargetLayout, ImageView imageView, RelativeLayout relativeLayout, FillLayout fillLayout, FillLayout fillLayout2, FillLayout fillLayout3, RelativeLayout relativeLayout2, FrameLayout frameLayout, FrameLayout frameLayout2, ImageView imageView2) {
    ...
    public static ComplicationsDraganddropTargetLayoutOneSubComplicationBinding bind(View view) {
                            ...
                            if (relativeLayout2 != null) {
                                ...
                                if (frameLayout != null) {
                                    ...
                                    if (frameLayout2 != null) {
                                        ...
                                        if (imageView2 != null) {
                                            return new ComplicationsDraganddropTargetLayoutOneSubComplicationBinding((BehaviourDragAndDropTargetLayout) view, imageView, relativeLayout, fillLayout, fillLayout2, fillLayout3, relativeLayout2, frameLayout, frameLayout2, imageView2);
                                        }
                                    }
                                }
                            }
    ...
    public static ComplicationsDraganddropTargetLayoutOneSubComplicationBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ComplicationsDraganddropTargetLayoutOneSubComplicationBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.complications_draganddrop_target_layout_one_sub_complication, viewGroup, false);
        if (z) {
