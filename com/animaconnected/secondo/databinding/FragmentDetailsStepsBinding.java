...
public final class FragmentDetailsStepsBinding implements ViewBinding {
    ...
    public final TextView percentageSteps;
    private final LinearLayout rootView;
    public final ImageView slotDivider;
    public final TextView subComplicationTitle;
    public final TextView titleTextView;

    private FragmentDetailsStepsBinding(LinearLayout linearLayout, MorseCodeView morseCodeView, DetailWatchPager detailWatchPager, Button button, LinearLayout linearLayout2, ImageView imageView, LinearLayout linearLayout3, TextView textView, ImageView imageView2, TextView textView2, TextView textView3) {
        ...
        this.percentageSteps = textView;
        this.slotDivider = imageView2;
        this.subComplicationTitle = textView2;
        this.titleTextView = textView3;
    }

    public static FragmentDetailsStepsBinding bind(View view) {
                    ...
                    if (linearLayout != null) {
                        ...
                        if (imageView != null) {
                            ...
                            if (linearLayout2 != null) {
                                r0 = R.id.percentage_steps;
                                TextView textView = (TextView) ViewBindings.findChildViewById(R.id.percentage_steps, view);
                                if (textView != null) {
                                    ...
                                    if (imageView2 != null) {
                                        ...
                                        if (textView2 != null) {
                                            ...
                                            if (textView3 != null) {
                                                return new FragmentDetailsStepsBinding((LinearLayout) view, morseCodeView, detailWatchPager, button, linearLayout, imageView, linearLayout2, textView, imageView2, textView2, textView3);
                                            }
                                        }
                                    }
                                }
    ...
    public static FragmentDetailsStepsBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentDetailsStepsBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.fragment_details_steps, viewGroup, false);
        if (z) {
