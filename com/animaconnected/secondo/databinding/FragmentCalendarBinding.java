...
public final class FragmentCalendarBinding implements ViewBinding {
    ...
    private FragmentCalendarBinding(RelativeLayout relativeLayout, FrameLayout frameLayout, LinearLayout linearLayout, TextView textView) {
    ...
    public static FragmentCalendarBinding bind(View view) {
        ...
        if (frameLayout != null) {
            ...
            if (linearLayout != null) {
                ...
                if (textView != null) {
                    return new FragmentCalendarBinding((RelativeLayout) view, frameLayout, linearLayout, textView);
                }
            }
        }
