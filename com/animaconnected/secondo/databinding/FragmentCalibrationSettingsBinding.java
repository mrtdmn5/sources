...
public final class FragmentCalibrationSettingsBinding implements ViewBinding {
    ...
    private FragmentCalibrationSettingsBinding(FrameLayout frameLayout, Button button, ViewPager viewPager, Button button2, FrameLayout frameLayout2, TextView textView, CalibrationWheelView calibrationWheelView, CirclePageIndicator circlePageIndicator) {
    ...
    public static FragmentCalibrationSettingsBinding bind(View view) {
                        ...
                        if (textView != null) {
                            ...
                            if (calibrationWheelView != null) {
                                ...
                                if (circlePageIndicator != null) {
                                    return new FragmentCalibrationSettingsBinding((FrameLayout) view, button, viewPager, button2, frameLayout, textView, calibrationWheelView, circlePageIndicator);
                                }
                            }
                        }
                    }
    ...
    public static FragmentCalibrationSettingsBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentCalibrationSettingsBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.fragment_calibration_settings, viewGroup, false);
        if (z) {
