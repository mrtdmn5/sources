...
public final class FragmentOnboardingLoginWithEmailBinding implements ViewBinding {
    ...
    private FragmentOnboardingLoginWithEmailBinding(LinearLayout linearLayout, Button button, Button button2, LayoutTextinputLoginBinding layoutTextinputLoginBinding, LinearLayout linearLayout2, LayoutTextinputLoginPasswordBinding layoutTextinputLoginPasswordBinding, ProgressBar progressBar, CustomToolbar customToolbar, TextView textView) {
    ...
    public static FragmentOnboardingLoginWithEmailBinding bind(View view) {
        int r0 = R.id.btn_continue;
        Button button = (Button) ViewBindings.findChildViewById(R.id.btn_continue, view);
        if (button != null) {
            r0 = R.id.btn_forgot_password;
            Button button2 = (Button) ViewBindings.findChildViewById(R.id.btn_forgot_password, view);
            if (button2 != null) {
                        ...
                        if (findChildViewById2 != null) {
                            ...
                            if (progressBar != null) {
                                ...
                                if (customToolbar != null) {
                                    ...
                                    if (textView != null) {
                                        return new FragmentOnboardingLoginWithEmailBinding((LinearLayout) view, button, button2, bind, linearLayout, bind2, progressBar, customToolbar, textView);
                                    }
                                }
                            }
                        }
    ...
    public static FragmentOnboardingLoginWithEmailBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentOnboardingLoginWithEmailBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.fragment_onboarding_login_with_email, viewGroup, false);
        if (z) {
