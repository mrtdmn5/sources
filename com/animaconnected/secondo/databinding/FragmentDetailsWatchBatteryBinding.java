...
public final class FragmentDetailsWatchBatteryBinding implements ViewBinding {
    ...
    public final TextView percentageWatchBattery;
    private final LinearLayout rootView;
    public final ImageView slotDivider;
    public final TextView subComplicationTitle;
    public final TextView titleTextView;

    private FragmentDetailsWatchBatteryBinding(LinearLayout linearLayout, MorseCodeView morseCodeView, DetailWatchPager detailWatchPager, LinearLayout linearLayout2, ImageView imageView, LinearLayout linearLayout3, TextView textView, ImageView imageView2, TextView textView2, TextView textView3) {
        ...
        this.percentageWatchBattery = textView;
        this.slotDivider = imageView2;
        this.subComplicationTitle = textView2;
        this.titleTextView = textView3;
    }

    public static FragmentDetailsWatchBatteryBinding bind(View view) {
                ...
                if (linearLayout != null) {
                    ...
                    if (imageView != null) {
                        ...
                        if (linearLayout2 != null) {
                            r0 = R.id.percentage_watch_battery;
                            TextView textView = (TextView) ViewBindings.findChildViewById(R.id.percentage_watch_battery, view);
                            if (textView != null) {
                                ...
                                if (imageView2 != null) {
                                    ...
                                    if (textView2 != null) {
                                        ...
                                        if (textView3 != null) {
                                            return new FragmentDetailsWatchBatteryBinding((LinearLayout) view, morseCodeView, detailWatchPager, linearLayout, imageView, linearLayout2, textView, imageView2, textView2, textView3);
                                        }
                                    }
                                }
                            }
    ...
    public static FragmentDetailsWatchBatteryBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentDetailsWatchBatteryBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.fragment_details_watch_battery, viewGroup, false);
        if (z) {
