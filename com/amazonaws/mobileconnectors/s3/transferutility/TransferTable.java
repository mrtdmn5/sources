...
class TransferTable {
    ...
    public static void onCreate(SQLiteDatabase sQLiteDatabase, int r2) {
        sQLiteDatabase.execSQL(DATABASE_CREATE);
        onUpgrade(sQLiteDatabase, 1, r2);
    }

    public static void onUpgrade(SQLiteDatabase sQLiteDatabase, int r2, int r3) {
        if (r2 < 2 && r3 >= 2) {
