...
/* compiled from: CustomSignInEvent.kt */
...
public final class CustomSignInEvent implements StateMachineEvent {
    ...
    public static abstract class EventType {
        ...
        public static final class InitiateCustomSignIn extends EventType {
            ...
            public static /* synthetic */ InitiateCustomSignIn copy$default(InitiateCustomSignIn initiateCustomSignIn, String str, Map map, int r3, Object obj) {
                if ((r3 & 1) != 0) {
            ...
            public String toString() {
                StringBuilder sb = new StringBuilder("InitiateCustomSignIn(username=");
    ...
    public /* synthetic */ CustomSignInEvent(EventType eventType, Date date, int r3, DefaultConstructorMarker defaultConstructorMarker) {
