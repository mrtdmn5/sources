...
public final class CognitoUserPoolTokens$$serializer implements GeneratedSerializer<CognitoUserPoolTokens> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.amplifyframework.statemachine.codegen.data.CognitoUserPoolTokens", cognitoUserPoolTokens$$serializer, 4);
        pluginGeneratedSerialDescriptor.addElement("idToken", false);
    ...
    public CognitoUserPoolTokens deserialize(Decoder decoder) {
        ...
        return new CognitoUserPoolTokens(r10, (String) obj, (String) obj4, (String) obj2, (Long) obj3, null);
    }
    ...
    public void serialize(Encoder encoder, CognitoUserPoolTokens value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder beginStructure = encoder.beginStructure(descriptor2);
        CognitoUserPoolTokens.write$Self(value, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
