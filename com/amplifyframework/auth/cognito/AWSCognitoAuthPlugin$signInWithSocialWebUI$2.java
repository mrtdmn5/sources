...
@DebugMetadata(c = "com.amplifyframework.auth.cognito.AWSCognitoAuthPlugin$signInWithSocialWebUI$2", f = "AWSCognitoAuthPlugin.kt", l = {337}, m = "invokeSuspend")
/* loaded from: classes.dex */
public final class AWSCognitoAuthPlugin$signInWithSocialWebUI$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AWSCognitoAuthPlugin$signInWithSocialWebUI$2(this.this$0, this.$provider, this.$callingActivity, this.$options, this.$onSuccess, this.$onError, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((AWSCognitoAuthPlugin$signInWithSocialWebUI$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
