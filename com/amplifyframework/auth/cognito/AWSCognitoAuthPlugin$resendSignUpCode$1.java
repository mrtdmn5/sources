...
@DebugMetadata(c = "com.amplifyframework.auth.cognito.AWSCognitoAuthPlugin$resendSignUpCode$1", f = "AWSCognitoAuthPlugin.kt", l = {210}, m = "invokeSuspend")
/* loaded from: classes.dex */
public final class AWSCognitoAuthPlugin$resendSignUpCode$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((AWSCognitoAuthPlugin$resendSignUpCode$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
