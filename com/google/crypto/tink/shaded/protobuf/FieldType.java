...
public final class FieldType {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            int[] r0 = new int[JavaType.values().length];
            $SwitchMap$com$google$protobuf$JavaType = r0;
            try {
                r0[JavaType.BYTE_STRING.ordinal()] = 1;
    ...
    private FieldType(String str, int r2, int r3, Collection collection, JavaType javaType) {
        int r1;
        this.id = r3;
        this.collection = collection;
        this.javaType = javaType;
        int r12 = AnonymousClass1.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        if (r12 != 1) {
            if (r12 != 2) {
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (r1 = AnonymousClass1.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || r1 == 2 || r1 == 3) ? false : true;
    }

    public static FieldType forId(int r2) {
        if (r2 >= 0) {
            FieldType[] fieldTypeArr = VALUES;
            if (r2 < fieldTypeArr.length) {
                return fieldTypeArr[r2];
            }
            return null;
        }
        return null;
                    ...
                    for (int r4 = 0; r4 < actualTypeArguments.length; r4++) {
                        ...
                        if (type instanceof TypeVariable) {
                            ...
                            if (typeArr.length == typeParameters.length) {
                                int r7 = 0;
                                while (true) {
                                    if (r7 < typeParameters.length) {
                                        if (type == typeParameters[r7]) {
                                            actualTypeArguments[r4] = typeArr[r7];
                                            z = true;
                                            break;
                                        }
                                        r7++;
