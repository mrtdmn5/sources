...
public class TypeToken<T> {
    ...
    public static TypeToken<?> getArray(Type type) {
        return new TypeToken<>(new C$Gson$Types.GenericArrayTypeImpl(type));
    }
        ...
        if (type instanceof Class) {
            ...
            if (length2 == length) {
                for (int r3 = 0; r3 < length; r3++) {
                    Type type2 = typeArr[r3];
                    Class<?> rawType = C$Gson$Types.getRawType(type2);
                    TypeVariable<Class<T>> typeVariable = typeParameters[r3];
                ...
                return new TypeToken<>(new C$Gson$Types.ParameterizedTypeImpl(null, type, typeArr));
            }
