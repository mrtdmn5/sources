...
public final class StandardUUIDsParser {
    public static final Map<String, String> CHARACTERISTIC_UUIDS;
    public static final Map<String, String> DESCRIPTOR_UUIDS;
    public static final Map<String, String> SERVICE_UUIDS;
    ...
    static {
        ...
        hashMap2.put("2A6E", Temperature.TYPE);
    ...
    public static String getStandardizedUUIDComponent(UUID r2) {
        boolean z;
