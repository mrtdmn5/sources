...
public class DropDownListView extends ListView {
    ...
    public final Field mIsChildViewEnabled;
    ...
    public final int measureHeightOfChildrenCompat(int r12, int r13) {
        int makeMeasureSpec;
        ...
        int r0 = listPaddingTop + listPaddingBottom;
        if (adapter == null) {
            return r0;
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:9:0x0126 A[ADDED_TO_REGION] */
    /*
