...
public final class WorkDatabase_Impl extends WorkDatabase {
    ...
    public class AnonymousClass1 extends RoomOpenHelper.Delegate {
        ...
        public final void createAllTables(FrameworkSQLiteDatabase _db) {
        ...
        @Override // androidx.room.RoomOpenHelper.Delegate
        public final RoomOpenHelper.ValidationResult onValidateSchema(FrameworkSQLiteDatabase _db) {
            ...
            hashSet.add(new TableInfo.ForeignKey("WorkSpec", "CASCADE", "CASCADE", Arrays.asList("work_spec_id"), Arrays.asList(ConfigurationItem.COLUMN_NAME_ID)));
            hashSet.add(new TableInfo.ForeignKey("WorkSpec", "CASCADE", "CASCADE", Arrays.asList("prerequisite_id"), Arrays.asList(ConfigurationItem.COLUMN_NAME_ID)));
            HashSet hashSet2 = new HashSet(2);
            hashSet2.add(new TableInfo.Index("index_Dependency_work_spec_id", Arrays.asList("work_spec_id"), false));
            hashSet2.add(new TableInfo.Index("index_Dependency_prerequisite_id", Arrays.asList("prerequisite_id"), false));
            ...
            hashMap2.put(ConfigurationItem.COLUMN_NAME_ID, new TableInfo.Column(ConfigurationItem.COLUMN_NAME_ID, "TEXT", true, 1, null, 1));
            ...
            hashSet4.add(new TableInfo.Index("index_WorkSpec_schedule_requested_at", Arrays.asList("schedule_requested_at"), false));
            hashSet4.add(new TableInfo.Index("index_WorkSpec_period_start_time", Arrays.asList("period_start_time"), false));
            ...
            hashSet5.add(new TableInfo.ForeignKey("WorkSpec", "CASCADE", "CASCADE", Arrays.asList("work_spec_id"), Arrays.asList(ConfigurationItem.COLUMN_NAME_ID)));
            HashSet hashSet6 = new HashSet(1);
            hashSet6.add(new TableInfo.Index("index_WorkTag_work_spec_id", Arrays.asList("work_spec_id"), false));
            ...
            hashSet7.add(new TableInfo.ForeignKey("WorkSpec", "CASCADE", "CASCADE", Arrays.asList("work_spec_id"), Arrays.asList(ConfigurationItem.COLUMN_NAME_ID)));
            ...
            hashSet8.add(new TableInfo.ForeignKey("WorkSpec", "CASCADE", "CASCADE", Arrays.asList("work_spec_id"), Arrays.asList(ConfigurationItem.COLUMN_NAME_ID)));
            HashSet hashSet9 = new HashSet(1);
            hashSet9.add(new TableInfo.Index("index_WorkName_work_spec_id", Arrays.asList("work_spec_id"), false));
            ...
            hashSet10.add(new TableInfo.ForeignKey("WorkSpec", "CASCADE", "CASCADE", Arrays.asList("work_spec_id"), Arrays.asList(ConfigurationItem.COLUMN_NAME_ID)));
            ...
            hashMap7.put(TransferTable.COLUMN_KEY, new TableInfo.Column(TransferTable.COLUMN_KEY, "TEXT", true, 1, null, 1));
    ...
    @Override // androidx.room.RoomDatabase
    public final SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
        RoomOpenHelper roomOpenHelper = new RoomOpenHelper(configuration, new AnonymousClass1());
        Context context = configuration.context;
        Intrinsics.checkNotNullParameter(context, "context");
        return configuration.sqliteOpenHelperFactory.create(new SupportSQLiteOpenHelper.Configuration(context, configuration.name, roomOpenHelper, false));
    }
