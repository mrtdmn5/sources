...
@DebugMetadata(c = "androidx.compose.foundation.AbstractClickableNode$onKeyEvent$1", f = "Clickable.kt", l = {718}, m = "invokeSuspend")
...
public final class AbstractClickableNode$onKeyEvent$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public AbstractClickableNode$onKeyEvent$1(AbstractClickableNode abstractClickableNode, PressInteraction$Press pressInteraction$Press, Continuation<? super AbstractClickableNode$onKeyEvent$1> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (r1 != 0) {
            ...
            this.label = 1;
            if (mutableInteractionSource.emit(this.$press, this) == coroutineSingletons) {
