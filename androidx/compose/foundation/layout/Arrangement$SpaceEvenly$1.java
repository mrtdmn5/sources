...
public final class Arrangement$SpaceEvenly$1 implements Arrangement.Horizontal, Arrangement.Vertical {
    ...
    public final void arrange(int r2, Density density, LayoutDirection layoutDirection, int[] sizes, int[] outPositions) {
        ...
        if (layoutDirection == LayoutDirection.Ltr) {
            Arrangement.placeSpaceEvenly$foundation_layout_release(r2, sizes, outPositions, false);
        } else {
            Arrangement.placeSpaceEvenly$foundation_layout_release(r2, sizes, outPositions, true);
        }
    }
    ...
    public final void arrange(Density density, int r3, int[] sizes, int[] outPositions) {
        ...
        Intrinsics.checkNotNullParameter(sizes, "sizes");
        Intrinsics.checkNotNullParameter(outPositions, "outPositions");
        Arrangement.placeSpaceEvenly$foundation_layout_release(r3, sizes, outPositions, false);
    }
}
