...
public final class SelectionAdjustment$Companion$Paragraph$1 implements SelectionAdjustment {
    ...
    public final long mo139adjustZXO7KMw(TextLayoutResult textLayoutResult, long j, int r4, boolean z, TextRange textRange) {
        return SelectionAdjustment.Companion.m140access$adjustByBoundaryDvylE(textLayoutResult, j, new SelectionAdjustment$Companion$Paragraph$1$adjust$boundaryFun$1(textLayoutResult.layoutInput.text));
    }
}
